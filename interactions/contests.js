...
const platforms = {
    codechef: {
        ...
        thumb: "https://i.imgur.com/XdBzq6c.jpg",
    },
    leetcode: {
        name: "LeetCode",
        url: "https://leetcode.com",
        thumb: "https://i.imgur.com/slIjkP3.jpg",
    },
    hackerrank: {
        name: "HackerRank",
        url: "https://www.hackerrank.com",
        thumb: "https://i.imgur.com/sduFQNq.jpg",
    },
    codeforces: {
        name: "CodeForces",
        url: "https://codeforces.com",
        thumb: "https://i.imgur.com/EVmQOW5.jpg",
    },
    atcoder: {
        name: "AtCoder",
        url: "https://atcoder.jp",
        thumb: "https://i.imgur.com/mfB9fEI.jpg",
    },
    hackerearth: {
        name: "HackerEarth",
        url: "https://www.hackerearth.com",
        thumb: "https://i.imgur.com/CACYwoz.jpg",
    },
    kickstart: {
        name: "Google KickStart",
        url: "https://codingcompetitions.withgoogle.com/kickstart",
        thumb: "https://i.imgur.com/lQWWQ2f.jpg",
    },
};
...
async function contestsPaginate(interaction) {
    ...
    if (interaction.isButton()) {
        ...
        platform = interaction.customId.substring(
            15,
    ...
    let maxContests =
        pageNum * contestsPerPage +
        (contestsCount > contestsPerPage ? contestsPerPage : contestsCount);
    for (let i = pageNum * contestsPerPage; i < maxContests; i++) {
        ...
        let durationLeft =
            contestData["duration"] + contestData["start"] - Date.now() / 1000;
        ...
        if (ongoing) {
            ...
            respStr += `**[${contestData["name"]}](${
                contestData["url"]
            })**\n:stopwatch: **Time left:** ${hoursLeft} ${
                hoursLeft === 1 ? "hour" : "hours"
            } and ${minsLeft} ${minsLeft === 1 ? "minute" : "minutes"}`;
        } else {
            if (!upcomingTextSent) {
            ...
            respStr += `**[${contestData["name"]}](${
                contestData["url"]
            })**\n:calendar: **Start:** <t:${contestData["start"]}:D> at <t:${
                contestData["start"]
            }:t>\n:stopwatch: **Duration:** ${hours} ${
                hours === 1 ? "hour" : "hours"
    ...
    if (data.length > contestsPerPage)
        embed.setFooter({
            text: `Current page ${pageNum + 1}/${
                Math.trunc(data.length / contestsPerPage) + 1
            }`,
        });
