...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = await embedMessage(interaction,'Wish to get notified about coding contests?','Click the **Notifications** button below to get a role which will be pinged whenever any coding contest on CodeChef, LeetCode, HackerRank, CodeForces, AtCoder, HackerEarth and Geeks for Geeks are about to start. Click it again to opt-out anytime.',false,'https://github.com/roshan1337d/coding-contests-companion',true);
