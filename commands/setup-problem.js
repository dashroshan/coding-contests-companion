...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addChannelOption(
            new SlashCommandChannelOption()
                .setName("channel")
                .setDescription(
                    "Select the channel where daily problems will be sent"
                )
                .setRequired(true)
        )
    ...
    async execute(interaction) {
        ...
        await interaction.client.database.saveProblemChannel(
            interaction.guildId,
            channel.id
        );
        await embedMessage(
            interaction,
            "SERVICE ACTIVATED",
            "Problem of the day service has been actived for you server!",
            false
        );
