...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = await embedMessage(
            interaction,
            "CODING CONTESTS",
            "Select a contest platform using the selection box below. CodeChef, LeetCode, HackerRank, CodeForces, AtCoder, HackerEarth, and Google KickStart are the currently available platforms. Support for more platforms coming soon :sparkles:",
            false,
